...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer(null, "Customer1", "123A", address8, "123456789", "customer1@email.com", null);
        Customer customer2 = new Customer(null, "Customer2", "456B", address9, "987654321", "customer2@email.com", null);
        Customer customer3 = new Customer(null, "Customer3", "789C", address10, "468526445", "customer3@email.com", null);
        Customer customer4 = new Customer(null, "Customer4", "111C", address11, "666666666", "customer4@email.com", null);
