...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Task task11 = new Task(null, "NanoGen", "Nanobot generator system", LocalDate.of(2023, 1, 9), project2, employee10, Status.COMPLETED, Priority.CRITICAL);
        Task task12 = new Task(null, "QuantumLeap", "Quantum computing platform", LocalDate.of(2008, 12, 12), project4, employee10, Status.CANCELED, Priority.HIGH);
        Task task13 = new Task(null, "BrainWave", "Mind-controlled interface technology", LocalDate.of(2020, 9, 30), project6, employee10, Status.IN_PROGRESS, Priority.MEDIUM);
        Task task14 = new Task(null, "AeroDyne", "Autonomous flying drone fleet", LocalDate.of(2021, 5, 25), project8, employee10, Status.PENDING, Priority.CRITICAL);
        Task task15 = new Task(null, "BioSim", "Biomedical simulation software", LocalDate.of(1999, 9, 17), project10, employee10, Status.COMPLETED, Priority.LOW);
        Task task16 = new Task(null, "CyberGuard", "Advanced cybersecurity suite", LocalDate.of(2004, 11, 30), project9, employee10, Status.IN_PROGRESS, Priority.HIGH);
        ...
        Task task18 = new Task(null, "SmartHome", "Intelligent home automation system\n", LocalDate.of(2025, 8, 22), project5, employee10, Status.CANCELED, Priority.MEDIUM);
        Task task19 = new Task(null, "BioFueler", "Algae-based biofuel production", LocalDate.of(1997, 10, 4), project1, employee10, Status.CANCELED, Priority.MEDIUM);
        Task task20 = new Task(null, "MindMesh", "Neural network modeling software", LocalDate.of(2021, 12, 3), project3, employee10, Status.COMPLETED, Priority.LOW);
        Task task21 = new Task(null, "SkyView", "Satellite imagery analysis platform", LocalDate.of(2023, 8, 5), project10, employee10, Status.COMPLETED, Priority.HIGH);
        Task task22 = new Task(null, "GeoTrack", "Real-time GPS tracking system\n", LocalDate.of(2021, 1, 7), project3, employee10, Status.CANCELED, Priority.CRITICAL);
        Task task23 = new Task(null, "HealthHub", "Personalized health monitoring device", LocalDate.of(2009, 9, 30), project9, employee10, Status.PENDING, Priority.LOW);
        Task task24 = new Task(null, "GreenGen", "Renewable energy grid optimization", LocalDate.of(2022, 9, 3), project5, employee10, Status.CANCELED, Priority.CRITICAL);
        Task task25 = new Task(null, "NeuralNet", "Artificial intelligence training system", LocalDate.of(2026, 2, 9), project3, employee10, Status.PENDING, Priority.MEDIUM);
        Task task26 = new Task(null, "DataForge", "Big data analytics toolset", LocalDate.of(2027, 12, 12), project10, employee8, Status.COMPLETED, Priority.MEDIUM);
        Task task27 = new Task(null, "AutoDrive", "Autonomous vehicle navigation system", LocalDate.of(2022, 4, 8), project7, employee10, Status.IN_PROGRESS, Priority.MEDIUM);
        Task task28 = new Task(null, "RoboGuard", "Automated security drone system", LocalDate.of(2020, 12, 20), project4, employee10, Status.IN_PROGRESS, Priority.LOW);
